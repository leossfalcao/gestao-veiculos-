...
public class GestaoVeiculosApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		AnimalEstimacao an1 = new AnimalEstimacao(1L, "Dog", "lei", "GRANDE",  data, m2);
